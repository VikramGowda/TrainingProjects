...
public class fileHandlingExample
{
    public static void main(String args[]) throws FileNotFoundException, IOException {
        ...
        {
            System.out.println("Sorry your try is unexpected ,Try again ");
        }
    ...
    public static void writingToFile(String s)
    {
        ...
        try
        {
            ...
            if(s.equalsIgnoreCase("w"))
            {
                ...
                System.out.println("CAUTION >> It will overwrite the content of the file ");
                ...
                if(s1.equals("no"))
                System.exit(0);
                System.out.println("Type 'stop' when you finish writing the file ");
                f.delete();
                f.createNewFile();
